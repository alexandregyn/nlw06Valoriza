...
import { AllComplimentController } from "./controllers/AllComplimentController";
...
router.get("/compliments/all", ensureAuthenticated, new AllComplimentController().getAll);
